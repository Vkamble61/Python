...
# All the elements that are only contained in album_set1
print("Only Album1 elements: ",album_set1.difference(album_set2))
# The elements in album_set2 but not in album_set1
print("Only Album2 elements: ",album_set2.difference(album_set1))
